  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          <p className='mb-3'>Product Catergory</p>
          <select onChange={(e)=>setCategory(e.target.value)} value={category} className='width-full px-3 py-2'>
        ...
        <div>
          <p className='mb-3'>Sub Catergory</p>
          <select onChange={(e)=>setSubCategory(e.target.value)} value={subCategory} className='width-full px-3 py-2'>
      ...
      <button type='submit' className='w-28 py-3 mt-4 bg-black text-white rounded-2xl transition-transform active:scale-95 hover:bg-gray-800'>Add</button>
    </form>
  )
}
